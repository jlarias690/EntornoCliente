function GeneraForm(e) {
  ...
  formulario.setAttribute("action", "https://www.google.es/"); //Asignar el atributo action
  ...
  cajaTextNombres.setAttribute(
    "style",
    "width:100%;margin: 10px 0px;padding: 5px"
  ); //Asignar el atributo style
  ...
  cajaTextApellidos.setAttribute(
    "style",
    "width:100%;margin: 10px 0px;padding: 5px"
  ); //Asignar el atributo style
  ...
  boton.setAttribute(
    "style",
    "width:100px;margin: 10px 0px;padding: 10px;background:#F05133;color:#fff;border:solid 1px #000;"
  ); //Asignar el atributo style
