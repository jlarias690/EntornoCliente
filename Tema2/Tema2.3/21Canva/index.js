...
function draw() {
  ...
  if (canvas.getContext) {
    ...
    let y = parseInt(Math.random(0, 1001));
    let x = parseInt(Math.random(0, 1001));
    let color1 = parseInt(Math.random(0, 256));
    let color2 = parseInt(Math.random(0, 256));
    let color3 = parseInt(Math.random(0, 256));
